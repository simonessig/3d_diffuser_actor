...
def evaluate_policy(model, env, conf_dir, eval_log_dir=None, save_video=False, sequence_indices=[]):
    """
    ...
    for seq_ind, (initial_state, eval_sequence) in enumerate(eval_sequences):
        ...
        result, videos = evaluate_sequence(
            env, model, task_oracle, initial_state, eval_sequence, val_annotations, save_video
        )
